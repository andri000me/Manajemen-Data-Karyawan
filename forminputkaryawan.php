...
<table width="1100" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
		<td align="right" width="789" height="32"><input type="button" value="Back To Home" onclick=location.href="index.php" title="kembali ke home">&nbsp;</td>
	</tr>
	<tr>
		<td width="20" height="36">&nbsp;</td>
		<td width="165">NIK</td>
		<td><input type="text" name="nik" size="15" maxlength="9" style="text-transform: uppercase;">&nbsp;* gunakan nomor NIK kemudian tambahkan angka ( ex : NIK000001 )</td>
	</tr>
	<tr>
		<td height="36">&nbsp;</td>
		<td>Nama</td>
	...
	<tr>
		<td height="36">&nbsp;</td>
		<td>Foto</td>
		<td><input type="file" name="foto" size="49"/>&nbsp;</td>
    </tr>
	<tr>
		<td height="36">&nbsp;</td>
		<td>Jenis Kelamin</td>
